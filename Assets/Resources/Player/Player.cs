...
public partial class Player : Entity
{
    ...
    public override void OnFixedUpdate()
    {
        ...
        else
        {
            ...
            BonusChoices = FirstChoiceIsInvestment = AllChoicesAreInvestment = false; //These updates need to happen here, so they are reset after powerups are updated but before equips (both come from equips and effect powers)
