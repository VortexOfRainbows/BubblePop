    ...
    public override void OnKill()
    {
        ...
        if (Data2 == 6)
        {
            for (int j = 0; j < 3; j++)
            {
                ...
                for (int i = 0; i < 14; i++)
                {
                    ...
                    NewProjectile<Spike>((Vector2)transform.position + circular * (j * 2f), circular * 2.0f, 1, Owner, Mathf.Sign(j % 2 * 2 - 1) * (1 + j * 0.5f), Data2 + r / 2.5f);
                }
            }
        }
        if (Data2 == 0)
        {
            for (int i = 0; i < 10; i++)
            {
                ...
                NewProjectile<Spike>((Vector2)transform.position + circular * 0.5f, circular * 2.0f, 1, Owner, 0, Data2);
            }
        }
        if (Data2 == 1)
        {
        ...
        if (Data2 == 2)
        {
            for (int i = 0; i < 24; i++)
            {
                ...
                NewProjectile<Spike>((Vector2)transform.position + circular * 0.5f, circular * 1.5f, 1, Owner, 0, Data2);
            }
        }
        if (Data2 == 3)
        {
        ...
        if (Data2 == 4)
        {
            for (int j = -1; j <= 1; j += 2)
            {
                for (int i = 0; i < 10; i++)
                {
                    ...
                    NewProjectile<Spike>((Vector2)transform.position + circular * 0.5f, circular * 2.0f, 1, Owner, j * 1f, Data2);
                }
            }
        }
        if (Data2 == 5)
        {
            for (float j = 1; j < 3.5f; j += 0.5f)
            {
                for (int i = 0; i < 4; i++)
                {
                    ...
                    NewProjectile<Spike>((Vector2)transform.position + circular * 0.25f, circular * 1.7f, 1, Owner, 1, Data2);
                }
            }
        }
