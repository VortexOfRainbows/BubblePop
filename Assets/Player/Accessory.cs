...
public class Accessory : Equipment
{
    ...
    private float MimicHatEulerZ = 0;
    protected override void AnimationUpdate()
    {
        ...
        float facingDir = Mathf.Sign(p.lastVelo.x);
        ...
        CapeB.transform.localPosition = new Vector2(Mathf.Lerp(-0.2f, 0.6f, 1 - p.squash) * toMouse.x * facingDir + addedXOffset, -.25f);
